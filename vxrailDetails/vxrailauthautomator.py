...
class VxRailAuthAutomator:
    ...
    def prepare_network_info_and_payload(self, hosts_spec_len, is_subnet_found, vsan_storage):
        ...
        if vsan_storage:
            ...
            vsan_vlan_id, vsan_cidr, vsan_subnet, vsan_gateway, vsan_ip_range = self.input_network_info(True, hosts_spec_len)
            print(*self.two_line_separator, sep='\n')
        ...
        vmotion_vlan_id, vmotion_cidr, vmotion_subnet, vmotion_gateway, vmotion_ip_range = \
            self.input_network_info(True, hosts_spec_len)
        print(*self.two_line_separator, sep='\n')
    ...
    def input_mgmt_network_info(self, hosts_spec_len):
        ...
        mgmt_vlan_id, mgmt_cidr, mgmt_subnet, mgmt_gateway, mgmt_ip_range = \
            self.input_network_info(False, hosts_spec_len)
        print(*self.two_line_separator, sep='\n')
    ...
    def input_network_info(self, ip_range_req, hosts_spec_len):
        cidr = ip_range = None
